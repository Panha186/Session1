...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
      ...
      arrayList.add(Row_Items_Activity("Burger", R.drawable.b1))
        ...
        arrayList2.add(popular_model(R.drawable.b1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
        arrayList2.add(popular_model(R.drawable.c1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
        arrayList2.add(popular_model(R.drawable.b1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
        arrayList2.add(popular_model(R.drawable.c1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
        arrayList2.add(popular_model(R.drawable.b1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
        arrayList2.add(popular_model(R.drawable.c1,"25 mins","4.9","Quinoa Garden Sald","Lorem ipsum dolor sit amet, consectetur"))
